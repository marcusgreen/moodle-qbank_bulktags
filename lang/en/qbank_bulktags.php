...
$string['replacetags_help'] = 'Remove existing tags before update. Leave the tags field empty and enable this option to remove all tags from the selected questions.';
